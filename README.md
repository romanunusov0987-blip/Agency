...
- `bot.py` — точка входа Telegram-бота: команда `/support`, регистрация панели
  «Личный кабинет» и синхронизация меню команд.
...
При запуске бот автоматически регистрирует команды `/support` и `/cab`,
устанавливает меню типа «Commands» и подготавливает inline-клавиатуру для
панели поддержки и личного кабинета.
